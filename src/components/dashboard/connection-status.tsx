...
const fallbackConnections: APIConnection[] = [
  { name: "Alpaca (Paper)", provider: "alpaca_paper", status: "disconnected" },
  { name: "Alpaca (Live)", provider: "alpaca_live", status: "disconnected" },
  { name: "OANDA", provider: "oanda", status: "disconnected" },
